...
taskname='task5' #loads in task with this name
...
save(simulated_data,file=paste(datadir,'/data_',taskname,sep=''))
...
write.csv(sim_data,paste0(datadir,'/simulated_data_',task_abbrev,'.csv'))
