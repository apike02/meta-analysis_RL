function likelihood = fit_2lr1s1lapse(params,fullid,simdata,tol,prior)
...
for t=1:trials
    ...
    if choices(t)==1
    qa_rew=qa_rew+alpha_rew*(sensitivity*rewardA(t) - qa_rew);
    qa_pun=qa_pun+alpha_pun*(sensitivity*punishA(t) - qa_pun);
    else 
    qb_rew=qb_rew+alpha_rew*(sensitivity*rewardB(t) - qb_rew);
    qb_pun=qb_pun+alpha_pun*(sensitivity*punishB(t) - qb_pun);
    end
end
