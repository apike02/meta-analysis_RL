function [results_1lr1b, results_1lr2b, results_2lr1b, results_2lr2b,...
    results_1lr1s,results_2lr1s,results_1lr2s,results_2lr2s,...
    results_1lr1s1lapse,results_2lr1s1lapse,results_1lr2s1lapse,...
    results_2lr2s1lapse] = mle
simdata=csvread('N:\Alex\metaRL\simulated_data\simulated_data.csv',1,1); 
...
results_2lr2s(:,7)=identifiers; %nparam+3
