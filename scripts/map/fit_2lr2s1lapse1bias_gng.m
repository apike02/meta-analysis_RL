function likelihood = fit_2lr2s1lapse1bias_gng(params,fullid,simdata,tol,prior)
...
for t=1:trials
    if stim(t)==1
        qa_go= (qa_rew_go + qa_pun_go + act_bias);
    ...
    elseif stim(t)==2
        qb_go = (qb_rew_go + qb_pun_go + act_bias);
     ...
     elseif stim(t)==3
        qc_go = (qc_rew_go + qc_pun_go + act_bias);
     ...
     elseif stim(t)==4
        qd_go = (qd_rew_go + qd_pun_go + act_bias);
