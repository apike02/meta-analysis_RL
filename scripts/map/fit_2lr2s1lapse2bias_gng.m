function likelihood = fit_2lr2s1lapse2bias_gng(params,fullid,simdata,tol,prior)

%one action bias, one approach/avoid pavlovian bias
...
for t=1:trials
    ...
    elseif stim(t)==2
        qb_go = (qb_rew_go + qb_pun_go + act_bias + app_bias*valueB);
     ...
     elseif stim(t)==4
        qd_go = (qd_rew_go + qd_pun_go + act_bias + app_bias*valueD);
