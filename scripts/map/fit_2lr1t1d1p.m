function likelihood = fit_2lr1t1d1p(params,fullid,simdata,tol,prior)
...
for t=1:trials
    ...
    QA=qa-max([qa qb]-perseverance*choice_trace(1));
    QB=qb-max([qa qb]-perseverance*choice_trace(2));
...
if nargin<4
    ...
    if group==1
        ...
        beta_lpmf(decay,prior{4,2}(1),prior{4,2}(2),tol)+...
