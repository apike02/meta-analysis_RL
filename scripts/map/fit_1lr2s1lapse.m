function likelihood = fit_1lr2s1lapse(params,fullid,simdata,tol,prior)
...
for t=1:trials
    ...
    if choices(t)==1
    qa_rew=qa_rew+alpha*(rewsens*rewardA(t) - qa_rew);
    qa_pun=qa_pun+alpha*(punsens*punishA(t) - qa_pun);
    else 
    qb_rew=qb_rew+alpha*(rewsens*rewardB(t) - qb_rew);
    qb_pun=qb_pun+alpha*(punsens*punishB(t) - qb_pun);
    end
end
