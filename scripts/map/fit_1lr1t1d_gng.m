function likelihood = fit_1lr1t1d_gng(params,fullid,simdata,tol,prior)
...
for t=1:trials
    if stim(t)==1
        ...
        prob(1)=exp(Q_go.*beta-choice_trace_go(1))./(exp(Q_go.*beta-choice_trace_go(1))+exp(Q_nogo.*beta-choice_trace_nogo(1)));
        prob(2)=exp(Q_nogo.*beta-choice_trace_nogo(1))./(exp(Q_nogo.*beta-choice_trace_nogo(1))+exp(Q_go.*beta-choice_trace_nogo(1)));
           if choices(t)==1
    ...
    elseif stim(t)==2
        ...
        prob(1)=exp(Q_go.*beta-choice_trace_go(2))./(exp(Q_go.*beta-choice_trace_go(2))+exp(Q_nogo.*beta-choice_trace_nogo(2)));
        prob(2)=exp(Q_nogo.*beta-choice_trace_nogo(2))./(exp(Q_nogo.*beta-choice_trace_nogo(2))+exp(Q_go.*beta-choice_trace_go(2)));
           if choices(t)==1
     ...
     elseif stim(t)==3
        ...
        prob(1)=exp(Q_go.*beta-choice_trace_go(3))./(exp(Q_go.*beta-choice_trace_go(3))+exp(Q_nogo.*beta-choice_trace_nogo(3)));
        prob(2)=exp(Q_nogo.*beta-choice_trace_nogo(3))./(exp(Q_nogo.*beta-choice_trace_nogo(3))+exp(Q_go.*beta-choice_trace_go(3)));
           if choices(t)==1
     ...
     elseif stim(t)==4
        ...
        prob(1)=exp(Q_go.*beta-choice_trace_go(4))./(exp(Q_go.*beta-choice_trace_go(4))+exp(Q_nogo.*beta-choice_trace_nogo(4)));
        prob(2)=exp(Q_nogo.*beta-choice_trace_nogo(4))./(exp(Q_nogo.*beta-choice_trace_nogo(4))+exp(Q_go.*beta-choice_trace_go(4)));
           if choices(t)==1
