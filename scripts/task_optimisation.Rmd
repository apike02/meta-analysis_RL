...
trialnumbers=c(20,50,100,200,300,400,500,1000,2000)


corr_long<-list()
for(i in 1:length(trialnumbers)){
  print(i)
  corr_long[[i]]<-run_genrec(ntrials=trialnumbers[i],newtask=1,model1='1lr1t1d1p',nsub=500,workingdir,tasktype = 'dependent') #creates task of X length
}
